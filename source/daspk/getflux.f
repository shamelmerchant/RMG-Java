...
C CALCULATE THE KEQ
         ...
         DG = 0
         DO J=1,RNUM
            DG = DG - THERMO(THIRDBODYREACTIONARRAY(I*22+2+J))
         END DO

         DO J=1,PNUM
            DG = DG + THERMO(THIRDBODYREACTIONARRAY(I*22+5+J))
         END DO
...
C     *************************************
         ...
         IF (THIRDBODYREACTIONARRAY(I*22+11) .EQ. 1) THEN
            RRATE = fRATE / KEQ
         ELSE
            RRATE = 0
         END IF
...
c         write(*,*) rrate, frate, thirdbodyreactionratearray(16*i+5)
         ...
         DO J=1,RNUM
            FRATE = FRATE*Y(THIRDBODYREACTIONARRAY(I*22+2+J))
         END DO

         DO J=1,PNUM
            RRATE = RRATE*Y(THIRDBODYREACTIONARRAY(I*22+5+J))
         END DO

         DO J=1,RNUM
            DEL(THIRDBODYREACTIONARRAY(20*i+2+J)) =
     $           DEL(THIRDBODYREACTIONARRAY(I*22+2+J)) - FRATE + RRATE
         END DO

         DO J=1,PNUM
            DEL(THIRDBODYREACTIONARRAY(I*22+5+J)) =
     $           DEL(THIRDBODYREACTIONARRAY(I*22+5+J)) + FRATE - RRATE
         END DO
