...
!DEC$ END IF
     ...
     $   troemax),lindereactionarray(22*lindemax),
...
C     
         do j=1,rnum
            zzzv3=dg-thermo(reactionarray(11*i+2+j))
            zzzvbar2=-1.0d0
            zzzvbar1=1.0d0
            dg=zzzv3
            call DSVM2(dgoft+1,2,zzzvbar2,thermooft+reactionarray(11*i+
     $         2+j),2,zzzvbar1,dgoft+1,2)
C     
         end do
         do j=1,pnum
            zzzv3=dg+thermo(reactionarray(11*i+5+j))
            zzzvbar2=1.0d0
            zzzvbar1=1.0d0
            dg=zzzv3
            call DSVM2(dgoft+1,2,zzzvbar2,thermooft+reactionarray(11*i+
...
C     
         ...
         do j=1,rnum
            ...
            call DSVM3(deloft+reactionarray(11*i+2+j),zzzsvm1,zzzvbar4,
     $         rrateoft+1,2,zzzvbar2,frateoft+1,2,zzzvbar1,deloft+
     $         reactionarray(11*i+2+j),zzzsvm1)
C     
         end do
         do j=1,pnum
            ...
            call DSVM3(deloft+reactionarray(11*i+5+j),zzzsvm1,zzzvbar4,
     $         rrateoft+1,2,zzzvbar2,frateoft+1,2,zzzvbar1,deloft+
     $         reactionarray(11*i+5+j),zzzsvm1)
C     
         end do
      end do
...
C     
         do j=1,rnum
            zzzv3=dg-thermo(thirdbodyreactionarray(22*i+2+j))
            zzzvbar2=-1.0d0
            zzzvbar1=1.0d0
            dg=zzzv3
            call DSVM2(dgoft+1,2,zzzvbar2,thermooft+
     $         thirdbodyreactionarray(22*i+2+j),2,zzzvbar1,dgoft+1,2)
C     
         end do
         do j=1,pnum
            zzzv3=dg+thermo(thirdbodyreactionarray(22*i+5+j))
            zzzvbar2=1.0d0
            zzzvbar1=1.0d0
            dg=zzzv3
            call DSVM2(dgoft+1,2,zzzvbar2,thermooft+
     $         thirdbodyreactionarray(22*i+5+j),2,zzzvbar1,dgoft+1,2)
C     
         end do
         zzzv2=-dg
         zzzv4=zzzv2*4184
...
C     
         ...
         do j=1,rnum
            ...
            call DSVM3(deloft+thirdbodyreactionarray(22*i+2+j),zzzsvm1
     $         ,zzzvbar4,rrateoft+1,2,zzzvbar2,frateoft+1,2,zzzvbar1,
     $         deloft+thirdbodyreactionarray(22*i+2+j),zzzsvm1)
C     
         end do
         do j=1,pnum
            ...
            call DSVM3(deloft+thirdbodyreactionarray(22*i+5+j),zzzsvm1
     $         ,zzzvbar4,rrateoft+1,2,zzzvbar2,frateoft+1,2,zzzvbar1,
     $         deloft+thirdbodyreactionarray(22*i+5+j),zzzsvm1)
C     
         end do
      end do
...
C     
         do j=1,rnum
            zzzv3=dg-thermo(troereactionarray(23*i+2+j))
            zzzvbar2=-1.0d0
            zzzvbar1=1.0d0
            dg=zzzv3
...
C     
         ...
         do j=1,pnum
            zzzv3=dg+thermo(troereactionarray(23*i+5+j))
            zzzvbar2=1.0d0
            zzzvbar1=1.0d0
            dg=zzzv3
            call DSVM2(dgoft+1,2,zzzvbar2,thermooft+troereactionarray(
...
C     
         ...
         do j=1,rnum
            ...
            call DSVM3(deloft+troereactionarray(23*i+2+j),zzzsvm1,
     $         zzzvbar4,rrateoft+1,2,zzzvbar2,frateoft+1,2,zzzvbar1,
     $         deloft+troereactionarray(23*i+2+j),zzzsvm1)
C     
         end do
         do j=1,pnum
            ...
            call DSVM3(deloft+troereactionarray(23*i+5+j),zzzsvm1,
     $         zzzvbar4,rrateoft+1,2,zzzvbar2,frateoft+1,2,zzzvbar1,
     $         deloft+troereactionarray(23*i+5+j),zzzsvm1)
C     
         end do
      end do
...
C     
         do j=1,rnum
            zzzv3=dg-thermo(lindereactionarray(22*i+2+j))
            zzzvbar2=-1.0d0
            zzzvbar1=1.0d0
            dg=zzzv3
...
C     
         ...
         do j=1,pnum
            zzzv3=dg+thermo(lindereactionarray(22*i+5+j))
            zzzvbar2=1.0d0
            zzzvbar1=1.0d0
            dg=zzzv3
            call DSVM2(dgoft+1,2,zzzvbar2,thermooft+lindereactionarray(
...
C     
         ...
         do j=1,rnum
            ...
            call DSVM3(deloft+lindereactionarray(22*i+2+j),zzzsvm1,
     $         zzzvbar4,rrateoft+1,2,zzzvbar2,frateoft+1,2,zzzvbar1,
     $         deloft+lindereactionarray(22*i+2+j),zzzsvm1)
C     
         end do
         do j=1,pnum
            ...
            call DSVM3(deloft+lindereactionarray(22*i+5+j),zzzsvm1,
     $         zzzvbar4,rrateoft+1,2,zzzvbar2,frateoft+1,2,zzzvbar1,
     $         deloft+lindereactionarray(22*i+5+j),zzzsvm1)
C     
         end do
      end do
