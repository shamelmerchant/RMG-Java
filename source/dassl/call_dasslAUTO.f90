...
! MAXIMUM # LINDEMANNREACTIONS = 100
     ...
     &     REACTIONARRAY(11*RMAX), THIRDBODYREACTIONARRAY(22*TBRMAX), &
     &     TROEREACTIONARRAY(23*TROEMAX), I, J, IDID, impspecies, &
     &     AUTOFLAG, ESPECIES, EREACTIONSIZE, ConstantConcentration(SPMAX+1), &
     &     LINDEREACTIONSIZE, LINDEREACTIONARRAY(22*LINDEMAX)

      DOUBLE PRECISION Y(SPMAX), YPRIME(SPMAX), T, TOUT, RTOL, ATOL,&
     &     RWORK(51+11*SPMAX+SPMAX**2), TEMPERATURE, PRESSURE,&
...
! READ INFORMATION ABOUT TROEREACTIONS
      ...
      READ(12,*)(TROEREACTIONARRAY(I),I=1,23*TROEREACTIONSIZE)
...
! READ INFORMATION ABOUT LINDEMANNREACTIONS
      ...
      READ(12,*)(LINDEREACTIONARRAY(I),I=1,22*LINDEREACTIONSIZE)
...
! specific to automatic time stepping
    ...
    &       IDEREAC(EREACTIONSIZE,3), IDEPROD(EREACTIONSIZE,5),&
    &            KVEC(EREACTIONSIZE))
        ...
        DO I=1, EREACTIONSIZE
         ...
         &            IDEPROD(I,2), IDEPROD(I,3), IDEPROD(I,4),IDEPROD(I,5), KVEC(I)
...
! READ RWORK AND IWORK
      IF (T .NE. 0.0) THEN
         ...
         READ(13) (RWORK(I),I=1,51+11*NSTATE+NSTATE**2)
...
!     INITIALIZE VARIABLES IN COMMON BLOC
    ...
    & EREACTIONSIZE, LINDEMAX
      ...
      INTEGER IDEREAC(EREACTIONSIZE,3), IDEPROD(EREACTIONSIZE,5)
    ...
    & HIGHESTRATIO
     ...
     &     REACTIONARRAY(11*RMAX), THIRDBODYREACTIONARRAY(22*TBRMAX), &
     &     TROEREACTIONARRAY(23*TROEMAX), I, J, NSTATE, EDGEFLAG,    &
     ...
     &     , RWORK(51 + 11*NSTATE + NSTATE**2), TARGETCONC, Y_OUTPT(NSTATE) &
     &     , YPRIME_OUTPT(NSTATE), TIME_OUTPT  &
     &     , RWORK_OUTPT(51 + 11*NSTATE + NSTATE**2)
